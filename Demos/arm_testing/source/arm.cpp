...
int main()
{
 ...
 {
     int speed = 10;
     sjsu::LogInfo("Moving arm to 10 degrees at " + speed + " rpm");
     arm.HandleMovement(10, speed);
     sjsu::Delay(10s);
     sjsu::LogInfo("Moving arm to 45 degrees at " + speed + " rpm");
     arm.HandleMovement(45, speed)
     sjsu::Delay(10s)
 }
