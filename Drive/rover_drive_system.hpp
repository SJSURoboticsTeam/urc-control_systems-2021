...
//#include "../../../library/lpc40xx/peripherals/gpio.hpp"
...
double StateOfCharge_LTC(){
  ...
  Ltc4150 *batterySensor = new Ltc4150(counter,pol,resistance);
 ...
 private:
  ...
  int state_of_charge_ = static_cast<int>(StateOfCharge_MAX());  // TODO - hardcoded for now
